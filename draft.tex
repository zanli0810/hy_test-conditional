...
As it is mentioned by \citep{wang2022maximum}, the IPW estimator $\hbeta_W$ is consistent, because the conditional expectation of the selection indicator $\delta$ give the data equals the inclusion probability and therefore the expectation of the objective function for the IPW estimator is the same as that of the full data MLE. 
...
For Eqs. \eqref{eq:score_W, eq:score_S}, we expense them at the true value $\btheta_0$, then we have
\begin{eqnarray}
